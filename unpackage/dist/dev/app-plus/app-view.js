...
var x=['./components/commom/load-more.wxml','./components/commom/nothing.wxml','./components/index-list.wxml','./components/tab-bar.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var z=gz$gwx_6()
var o2B=_n('view')
var c3B=_mz(z,'tab-bar',['bind:__l',0,'bind:changeTab',1,'currentIndex',1,'data-event-opts',2,'tabBars',3,'vueId',4],[],e,s,gg)
_(o2B,c3B)
var o4B=_n('view')
_rz(z,o4B,'class',6,e,s,gg)
var l5B=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var a6B=_v()
_(l5B,a6B)
var t7B=function(b9B,e8B,o0B,gg){
var oBC=_n('swiper-item')
var fCC=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',16,'class',1,'data-event-opts',2],[],b9B,e8B,gg)
var cDC=_v()
_(fCC,cDC)
if(_oz(z,19,b9B,e8B,gg)){cDC.wxVkey=1
var hEC=_v()
_(cDC,hEC)
var oFC=function(oHC,cGC,lIC,gg){
var tKC=_mz(z,'index-list',['bind:__l',24,'index',1,'item',2,'vueId',3],[],oHC,cGC,gg)
_(lIC,tKC)
return lIC
}
hEC.wxXCkey=4
_2z(z,22,oFC,b9B,e8B,gg,hEC,'item','index_list','index_list')
var eLC=_mz(z,'load-more',['bind:__l',28,'loadText',1,'vueId',2],[],b9B,e8B,gg)
_(cDC,eLC)
}
else{cDC.wxVkey=2
var bMC=_mz(z,'nothing',['bind:__l',31,'vueId',1],[],b9B,e8B,gg)
_(cDC,bMC)
}
cDC.wxXCkey=1
cDC.wxXCkey=3
...
a6B.wxXCkey=4
_2z(z,14,t7B,e,s,gg,a6B,'items','index','index')
_(o4B,l5B)
_(o2B,o4B)
_(r,o2B)
return r
...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"nothing{ position: absolute; background: #fff; top: 0; left: 0; bottom: 0; right: 0; }\n.",[1],"nothing wx-image{ width: 60%; }\n",],undefined,{path:"./pages/index/index.wxss"});    
